  ...
  Future<void> _publish() async {
    ...
    try {
      ...
      if (matches.isNotEmpty) {
        for (final match in matches) {
          try {
            ...
            await _notifService.notifyMatch(
              ...
              distance: match.distance,  // ✅ Distance correctement passée
            );
        ...
        print('📋 Vérifie que:');
        print('   - Un objet de type opposé existe dans Firestore');
        print('   - Les catégories correspondent (insensible à la casse)');
        print('   - Les couleurs correspondent (insensible à la casse)');
        print('   - Au moins un keyword est en commun');
        print('   - La distance est < 2km pour le bonus +10pts');
        print('   - Le score total est >= 30 pour être retenu');
      }

      if (mounted) {
        // 7. Naviguer vers l'écran de résultats
